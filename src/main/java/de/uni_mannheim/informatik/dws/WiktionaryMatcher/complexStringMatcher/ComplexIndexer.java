package de.uni_mannheim.informatik.dws.WiktionaryMatcher.complexStringMatcher;
...
public class ComplexIndexer {
    ...
    /**
     * Constructor.
     * @param simpleIndexer Simple Indexer that can be used to quickly derive an updated index.
     */
    public ComplexIndexer(SimpleIndexer simpleIndexer){
        this.uriLabelMap = simpleIndexer.uriLabelMap;
        runIndexingHighPerformance(simpleIndexer.index);
    }
     ...
     * @param oldIndex The old index on which the new index will be built.
     */
     ...
     * @param normalizedLabel The previously normalized label (by method {@link SimpleIndexer#simplyNormalize(String)}.
     * @return BOW instance.
     */
