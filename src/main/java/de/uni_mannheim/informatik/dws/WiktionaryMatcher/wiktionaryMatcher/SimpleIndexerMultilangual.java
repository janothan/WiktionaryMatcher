...
import static de.uni_mannheim.informatik.dws.WiktionaryMatcher.wiktionaryMatcher.WiktionaryKnowledgeSource.normalizeForTranslations;
...
public class SimpleIndexerMultilangual {
    ...
    public static String simplyNormalize(String stringToBeNormalized) {
        ...
        return normalizeForTranslations(stringToBeNormalized);
    }
