...
import de.uni_mannheim.informatik.dws.WiktionaryMatcher.wiktionaryMatcher.linking.WiktionaryLinker;
...
public class WiktionaryMatcher extends LabelBasedMatcher {
    ...
    /**
     * Multilangual mode of matcher. Default false.
     */
    private boolean isInMultiLangualMode = false;
    ...
    public WiktionaryMatcher() {
        ...
        isInMultiLangualMode = false;
    }

    /**
     * Constructor
     * @param isInMultilangualMode true if the ontologies are in different languages.
     */
    public WiktionaryMatcher(boolean isInMultilangualMode){
        this.wiktionary = new WiktionaryKnowledgeSource();
        this.linker = (WiktionaryLinker) this.wiktionary.getLinker();
        isInMultiLangualMode = true;
    }
    ...
    private void performBridgedFullStringTranslationMatch(UriLabelInfo uriLabelMap_1, UriLabelInfo uriLabelMap_2) {
        nextEntry1: for (HashMap.Entry<String, HashSet<LabelLanguageTuple>> entry_1 : uriLabelMap_1.getUriLabelMap().entrySet()) {
            ...
            nextEntry2: for (HashMap.Entry<String, HashSet<LabelLanguageTuple>> entry_2 : uriLabelMap_2.getUriLabelMap().entrySet()) {
